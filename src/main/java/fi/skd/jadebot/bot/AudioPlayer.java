...
public class AudioPlayer {
    ...
    void listTracks(TextChannel channel) {
        GuildMusicManager musicManager = getGuildAudioPlayer(channel.getGuild());
        BlockingQueue<AudioTrack> queue = musicManager.scheduler.getQueue();
        for (AudioTrack n : queue) {
            AudioTrackInfo info = n.getInfo();
            channel.sendMessage(info.title + " " + info.author + "\n" + info.uri).queue();
        }
    }
    ...
    String listAllTracks() {
        ...
        for (Map.Entry<Long, GuildMusicManager> entry : musicManagers.entrySet()) {
            ...
            GuildMusicManager musicManager = entry.getValue();
            BlockingQueue<AudioTrack> queue = musicManager.scheduler.getQueue();
            result += "Guild id: " + key + "<br>";
            result += "Playlist:<br>";
            for (AudioTrack n : queue) {
                AudioTrackInfo info = n.getInfo();
                result += info.title + " " + info.author + "<br>" + info.uri + "<br>";
            }
        }
        return result;
    }
